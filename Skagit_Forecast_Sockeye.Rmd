...
dat<-dat%>%
  ...
  mutate(
    ...
    lag2_NPGO = lag(NPGO,3),
    lag3_NPGO = lag(NPGO,4),
    lag2_smolts = lag(smolts,2),
...
vars<-c("lag2_NPGO","lag3_NPGO","lag2_smolts","lag3_smolts")#,"lag2_PC1","lag2_PC2","lag1_NPGO") #what regression variables will we use?
dat<-data.frame(dat)%>%
...
ARIMA100_withcov_NPGO_smolts<-tsCV2(y=log(dat$runsize_obs[-dim(dat)[1]]),
            Year=dat$Year,
            xreg=dat%>%dplyr::select("lag2_NPGO","lag3_NPGO","lag2_smolts","lag3_smolts")%>%as.matrix(),
            h=FY,
            min=TY,
            type="ARIMA",
            order=c(1,0,0)
...
ARIMA100_withcov_NPGO<-tsCV2(y=log(dat$runsize_obs[-dim(dat)[1]]),
            Year=dat$Year,
            xreg=dat%>%dplyr::select("lag2_NPGO","lag3_NPGO")%>%as.matrix(),
            h=FY,
            min=TY,
            type="ARIMA",
            order=c(1,0,0)
...
ARIMA100_withcov_smolts<-tsCV2(y=log(dat$runsize_obs[-dim(dat)[1]]),
            Year=dat$Year,
            xreg=dat%>%dplyr::select("lag2_smolts","lag3_smolts")%>%as.matrix(),
            h=FY,
            min=TY,
            type="ARIMA",
            order=c(1,0,0)
...
ARIMA111_withcov_NPGO_smolts<-tsCV2(y=log(dat$runsize_obs[-dim(dat)[1]]),
            Year=dat$Year,
            xreg=dat%>%dplyr::select("lag2_NPGO","lag3_NPGO","lag2_smolts","lag3_smolts")%>%as.matrix(),
            h=FY,
            min=TY,
...
ARIMA010_withcov_NPGO_smolts<-tsCV2(y=log(dat$runsize_obs[-dim(dat)[1]]),
            Year=dat$Year,
            xreg=dat%>%dplyr::select("lag2_NPGO","lag3_NPGO","lag2_smolts","lag3_smolts")%>%as.matrix(),
            h=FY,
            min=TY,
...
#             order=c(1,1,1)
# )
ARIMA101_withcov_NPGO_smolts<-tsCV2(y=log(dat$runsize_obs[-dim(dat)[1]]),
            Year=dat$Year,
            xreg=dat%>%dplyr::select("lag2_NPGO","lag3_NPGO","lag2_smolts","lag3_smolts")%>%as.matrix(),
            h=FY,
            min=TY,
...
ARIMA001_withcov_NPGO_smolts<-tsCV2(y=log(dat$runsize_obs[-dim(dat)[1]]),
            Year=dat$Year,
            xreg=dat%>%dplyr::select("lag2_NPGO","lag3_NPGO","lag2_smolts","lag3_smolts")%>%as.matrix(),
            h=FY,
            min=TY,
