...
#ARIMA models
#==========
LFO1<-tsCV2(y=log(dat$Steelhead[-dim(dat)[1]]),
              xreg=NULL,
              h=FY,
              min=TY,
              fc=fc,
...
LFO2<-tsCV2(y=log(dat$Steelhead[-dim(dat)[1]]),
      xreg=xreg,
      h=FY,
      min=TY,
      fc=fc,
...
LFO3<-tsCV2(y=log(dat$Steelhead[-dim(dat)[1]]),
            xreg=xreg,
            h=FY,
            min=TY,
            fc=fc,
...
LFO4<-tsCV2(y=log(dat$Steelhead[-dim(dat)[1]]),
            xreg=xreg,
            h=FY,
            min=TY,
            fc=fc,
...
LFO5<-tsCV2(y=log(dat$Steelhead[-dim(dat)[1]]),
            xreg=NULL,
            h=FY,
            min=TY,
            fc=fc,
...
LFO6<-tsCV2(y=log(dat$Steelhead[-dim(dat)[1]]),
            xreg=NULL,
            h=FY,
            min=TY,
            fc=fc,
...
LFO7<-tsCV2(y=log(dat$Steelhead[-dim(dat)[1]]),
            xreg=xreg,
            h=FY,
            min=TY,
            fc=fc,
...
LFO8<-tsCV2(y=log(dat$Steelhead[-dim(dat)[1]]),
            xreg=NULL,
            h=FY,
            min=TY,
            fc=fc,
...
#GAM models
#==========
LFO9<-tsCV2(y=log(dat$Steelhead[-dim(dat)[1]]),
            xreg=NULL,
            h=FY,
            min=TY,
            fc=fc2,
