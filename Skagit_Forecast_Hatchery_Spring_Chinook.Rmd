...
#pct_marked_by_age
#sub-yearling
forecast_sub_yearling <- forecast[1:6,]

forecast_sub_yearling <- cbind(age = c(2,3,4,5,6,7),trs = forecast_sub_yearling)

by.temp <- max(Yrlist,na.rm=T) - c(2,3,4,5,6,7)
...
forecast_yearling <- forecast[9:10,]

forecast_yearling <- cbind(age = c(4,5),trs = forecast_yearling)

by.temp <- max(Yrlist,na.rm=T) - c(4,5)
