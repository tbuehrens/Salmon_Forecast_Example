...
dat<-dat%>%
  ...
  mutate(
    ...
    lag0_TotalPinks = log(scale(tot_pk_num))
    )

#select variables to include in analysis and subset data
vars<-c("lag1_SAR1","lag2_SAR2", "lag1_NPGO","lag2_NPGO","lag1_TotalPinks","lag0_TotalPinks") #what regression variables will we use? 
dat<-data.frame(dat)%>%
