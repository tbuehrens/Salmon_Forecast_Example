...
dat4%>%
  kbl(caption = "Table 5. One-year ahead performance of model & model ensemble forecasts (using final year weights; not exact year-specific weights that would have been used if annually weighted).",digits =3)%>%
  kable_classic(full_width = F, html_font = "Cambria")
