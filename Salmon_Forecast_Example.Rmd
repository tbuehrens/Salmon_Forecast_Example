...
dat3%>%
  kbl(caption = "Table 2. Final Year One Year Ahead Forecast Performance",digits =3)%>%
  kable_classic(full_width = F, html_font = "Cambria")
```
...
ensembles<-NULL
for(i in 1: length(yrrange[1]:yrrange[2])){
...
#=================================
tdat%>%
  kbl(caption = "Table 3. Final Year One Year Ahead Model Weights",digits =3)%>%
  kable_classic(full_width = F, html_font = "Cambria")
...
ensembles%>%
  ...
  kbl(caption = "Table 4. Ensemble forecasts for final year of data.",digits =0)%>%
  kable_classic(full_width = F, html_font = "Cambria")
...
dat4%>%
  kbl(caption = "Table 5. One-year ahead performance of ensemble forecasts (using final year weights; not exact year-specific weights that would have been used if annually weighted).",digits =3)%>%
  kable_classic(full_width = F, html_font = "Cambria")
