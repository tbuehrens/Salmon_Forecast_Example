...
output:
  html_document:
    ...
    toc_float: yes
params:
  system: "Quinault" # system name, or blank when using as input via render()
editor_options: 
...
age_file<-paste0("../data/River_Files/",system_name,"_Age.csv")
...
dat<-dat%>%select(Year,runsize_obs,all_of(covar_used))
