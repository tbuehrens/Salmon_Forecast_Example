...
output:
  html_document:
    ...
    toc_float: yes
params:
  system: "Hoh" # system name, or blank when using as input via render()
editor_options: 
...
# Summarize Forecasts
#===================#
models<-c(ARIMAs,"prophet_model","random_forest","prophet_boost","elastic_net","gam","long_term_mean","last_year_obs",movavgs)
