...
dat<-dat%>%
  ...
  mutate(
    ...
    lag1_JCK = lag(scale(log(`Jack Chinook`))),
    ...
    lag1_PDO = lag(scale(PDO)),
    lag2_PDO = lag(scale(PDO),2)
    )
...
TY <- dim(dat)[1]-15 #training years (years of training data)
